         ...
         float4 frag(vertexOutput input) : COLOR
         {
            ...
            float d = lightDistance 
               * (asin(min(1.0, 
               ...
               - asin(min(1.0, _SphereRadius / sphereDistance)));// d as in the length of the light that determines the length of the penumbra. 
               //the angle between the ligth and the sphere is substracted by the angle between the tangent to the sphere and the the distance between sphere and plane 
               // non of them can be below 1.0
